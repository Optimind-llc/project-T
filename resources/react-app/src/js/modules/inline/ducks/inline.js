...
export function getInlines(partTypeIds) {
  return {
    [CALL_API]: {
      types: [
...
export function updateInline(id, max1, min1, max2, min2) {
  return {
    [CALL_API]: {
      types: [
        UPDATE_INLINE_DATA,
      ...
      endpoint: 'maintenance/inline/update',
      method: 'POST',
      body: {id, max1, min1, max2, min2}
    }
  };
}
