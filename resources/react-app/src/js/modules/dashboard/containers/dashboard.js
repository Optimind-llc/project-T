...
export default connect(mapStateToProps, mapDispatchToProps)(Dashboard);
        ...
        //                         this.setState({
        //                           pages: true,
        //                           pageTitle: `${p.name}工程　${i.name}　${g.line == '1' ? 'ライン①' : g.line == '2' ? 'ライン②' : ''}　${g.division.name}`,
        //                           process: p.id
        //                         });
        //                       }}
        //                     >
        ...
        //      <div
        //        className={state.realtime ? "range-date-wrap" : "range-date-wrap active"}
        //        onClick={() => this.setState({realtime: false})}
        //      >
        //        <p>日時を指定</p>
        //        <div>
        ...
        //      </div>
        //      <button
        //        className={state.realtime ? "active" : ""}
        //        onClick={() => this.setState({realtime: true})}
        //      >
        //       リアルタイム更新（現直＋前直）
        //      </button>
        ...
        //         <div
        //            className="pageWrap"
        //            onClick={() => this.setState({page: page.number})}
        //          >
        //            <p className={state.page == page.number ? "active" : ""}>
        //              <span>Page </span>{page.number}
        //            </p>
        //            <figure className={state.page == page.number ? "active" : ""}>
        //              <img src={page.path}/>
        //            </figure>
        //          </div>
        //       )
