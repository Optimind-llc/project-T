...
class RelatedHoleTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $luggageInnerSTD_holes = [
            [1, 1,  1005, 365, 'top',   'square', 'solid', 'FBD5B7'],
            [1, 2,  737,  365, 'top',   'square', 'solid', 'FBD5B7'],
            [1, 3,  1078, 713, 'top',   'square', 'solid', 'FBD5B7'],
            [1, 4,  1029, 714, 'top',   'square', 'solid', 'FBD5B7'],
            [1, 5,  1063, 773, 'bottom','square', 'solid', 'FBD5B7'],
            ...
            [1, 12, 1498, 299, 'right', 'square', 'solid', 'B3A3C6'],
            ...
            // [2, 36, 1117, 639, 'right','square', 'solid', '938957'],
            // [2, 37, 1022, 666, 'right','square', 'solid', '938957'],
            // [2, 38, 1126, 768, 'right','square', 'solid', '938957'],
            // [2, 39, 999,  794, 'right','square', 'solid', '938957'],
            // [2, 40, 720,  666, 'left', 'square', 'solid', '938957'],
            // [2, 41, 626,  640, 'left', 'square', 'solid', '938957'],
            // [2, 42, 741,  794, 'left', 'square', 'solid', '938957'],
            // [2, 43, 615,  770, 'left', 'square', 'solid', '938957'],

            [3, 44, 1374, 482, 'top',  'square', 'solid', 'F5964F'],
            [3, 45, 1294, 538, 'top',  'square', 'solid', 'F5964F'],
            [3, 46, 1090, 582, 'top',  'square', 'solid', 'F5964F'],
            [3, 47, 983,  632, 'top',  'square', 'solid', 'F5964F'],
            [3, 48, 913,  659, 'top',  'square', 'solid', 'F5964F'],
            [3, 49, 823,  649, 'top',  'square', 'solid', 'F5964F'],
            [3, 50, 651,  586, 'top',  'square', 'solid', 'F5964F'],
            [3, 51, 447,  539, 'top',  'square', 'solid', 'F5964F'],
            [3, 52, 366,  484, 'top',  'square', 'solid', 'F5964F'],
            ...
            [3, 59, 1452, 247, 'right', 'square', 'solid', '90E941'],
            [3, 60, 291,  251, 'left',  'square', 'solid', '90E941']
        ];
