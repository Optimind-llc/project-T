...
class RelatedHoleTableSeeder extends Seeder
{
    public function run()
    {
        ...
        $doorInnerR_holes = [
            ...
            [2, 28, 198,  796, 'left',  'square', 'solid', 'D89695'],
            ...
            [2, 44, 1179, 830, 'bottom','square', 'solid', '938957'],
        ...
        $luggageInnerARW_holes = [
            ...
            [2, 36, 1286, 594, 'right','square', 'solid', '938957', 1],
            [2, 37, 1104, 630, 'right','square', 'solid', '938957', 1],
            [2, 38, 1301, 696, 'right','square', 'solid', '938957', 1],
            [2, 39, 1113, 755, 'right','square', 'solid', '938957', 1],
            [2, 40, 624,  630, 'left', 'square', 'solid', '938957', 1],
            [2, 41, 446,  595, 'left', 'square', 'solid', '938957', 1],
            [2, 42, 613,  756, 'left', 'square', 'solid', '938957', 1],
            [2, 43, 429,  697, 'left', 'square', 'solid', '938957', 1],
